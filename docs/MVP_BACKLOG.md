...
- 注意：`HotKeyManagerTests` 注册全局热键 ⌥X，跑测试前确认无其他 xcodebuild 进程占用热键。
...
**范围**：
1. 帮助文档（帮助中心/README）：安装、使用（⌥X 唤出、拖入、拖出移动、清空）、FAQ
...
| Task | 状态 | 提交 | 备注 |
|------|------|------|------|
| Task 1 设置窗口 | ✅ 完成（2026-08-11） | `21701ec` | SettingsView 完整表单 + 快捷键录制；36 测试 0 失败 |
